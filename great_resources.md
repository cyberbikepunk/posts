...
* [Raymond Hettinger on beautiful idiomatic python](https://www.youtube.com/watch?v=OSGv2VnC0go)
* [Learning to thread in Python](http://pymotw.com/2/threading/)
* [Awesome Python: a list of Python libraries ordered by theme](http://awesome-python.com/)
* [Python testing book and podcast](http://pythontesting.net/)
* [Code quizzes typically found in coding interviews](https://github.com/donnemartin/interactive-coding-challenges)
* [Intermediate python tutorial repo](https://github.com/IntermediatePython/intermediatePython)
* [David Beasly on python meta-programming](https://www.youtube.com/watch?v=sPiWg5jSoZI)
* [Guido van Rossum on the history of Python](https://www.youtube.com/watch?v=ugqu10JV7dk)
...
* [Notebook intro to Bokeh](http://nbviewer.ipython.org/github/bokeh/bokeh-notebooks/blob/master/index.ipynb)
